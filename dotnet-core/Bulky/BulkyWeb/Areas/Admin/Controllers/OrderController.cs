...
namespace Bulky.Areas.Customer.Controllers
{
	...
	public class OrderController: Controller
	{
        ...
        public OrderController(IUnitOfWork _unitOfWork, IConfiguration configuration)
        {
        ...
        public IActionResult DetailsPayNow()
        {
            ...
            var options = new SessionCreateOptions
            {
                ...
                Mode = "payment",
                SuccessUrl = _host + $"admin/order/PaymentConfirmation?orderHeaderId={OrderVM.OrderHeader.Id}",
                CancelUrl = _host + $"admin/order/details?orderId={OrderVM.OrderHeader.Id}",
            };
