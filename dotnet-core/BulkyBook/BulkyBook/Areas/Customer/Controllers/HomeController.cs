...
public class HomeController : Controller
{
    ...
    {
        IEnumerable<Product> products = unitOfWork.Product.GetAll(includeProps: "Category,CoverType");
    ...
    public IActionResult Details(int productId)
    {
        ShoppingCart shoppingCart = new()
        {
            Count = 1,
            ProductId = productId,
            Product = unitOfWork.Product.GetFirstOrDefaultNull(p => p.Id == productId, includeProps: "Category,CoverType")
        };
