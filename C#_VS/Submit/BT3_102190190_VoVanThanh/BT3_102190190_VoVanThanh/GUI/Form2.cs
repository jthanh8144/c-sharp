...
using BT3_102190190_VoVanThanh.BLL;

namespace BT3_102190190_VoVanThanh.GUI
{
    public partial class Form2 : Form
    {
        ...
        private void AddStudent()
        {
            ...
            if (tb_StudentID.Text.Length > 10)
            {
                MessageBox.Show("Student ID is less than 10 characters long!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                status = false;
                return;
            }
